...
<body>
  ...
  <video autoplay muted loop id="myVideo">
    <source height="auto" width="100%" id="videoBG" src="clip/building.mp4" type="video/mp4">
            ...
            <?php  foreach($result as $data){ ?>
             <style>
              ...
              <div class="col-md-6 col-lg-4 col-xl-3">
                <div id="product-<?php echo $data['id'];?>" class="single-product" data-aos="fade-left">
                  <div class="part-1">
                    <ul>
                      <li ><a href="https://api.whatsapp.com/send?phone=6285282330303&text=Assalamu%27alaikum.%0D%0A%0D%0ANama%20%20%20%20%3A%20%0D%0AAlamat%20%20%3A%0D%0ANo%20HP%20%20%20%3A%0D%0A%0D%0AIngin%20Konsultasi%20tentang%20Produk%20%3A%0D%0A%0D%0A%2ANama%20Produk%2A%20%3A<?php echo $data['nama']?>%0D%0A%2AHarga%2A%3A<?php echo $data['harga']?>%0D%0A%2AFoto%2A%20%3A<?php echo 'https://alumuniumff.com/foto/'.$data['foto']?>""><i class="fa-brands fa-whatsapp"> </i></a></li>
